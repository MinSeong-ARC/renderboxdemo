 ...
 *
 * The Camera class contains camera-specific matrices and the draw function.
 * We will only be using one camera for the foreseeable future, but it should be easy to
 * extend to RenderBox to use multiple cameras
 */
